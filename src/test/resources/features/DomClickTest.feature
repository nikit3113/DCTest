...
Функционал: Тестирование ресурса DomClick
  ...
  Сценарий: Просмотр результатов поиска
    ...
    Когда пользователь (нажимает кнопку) "Выпадающие меню со списком городов"
    ...
    Тогда открывается страница "Страница поиска на карте"
    ...
    Тогда открывается страница "Страница поиска - список"

    И пользователь (нажимает кнопку) "Первый элемент списка"

    Тогда открывается страница "Выбранная квартира"

    И пользователь (нажимает кнопку) "Отправить квартиру на одобрение"